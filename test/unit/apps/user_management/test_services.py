...
from python_webapp.apps.user_management.domain import User, Profile
...
@pytest.mark.asyncio
async def test_create_user(user_repository_mock: UserRepository):
...
@pytest.mark.asyncio
async def test_create_user_duplicate_email_error(user_repository_mock: UserRepository):
...
@pytest.mark.asyncio
async def test_get_user_by_id_not_found_error(user_repository_mock: UserRepository):
...
@pytest.mark.asyncio
async def test_delete_user_by_id(user_repository_mock: UserRepository):
...
@pytest.mark.asyncio
async def test_update_user_by_id(user_repository_mock: UserRepository):
